...
import java.util.ArrayList;public class instancia4{
 int x=2 ;
 int y=2 ;
String k="" ;
String f="" ;
...
public instancia4(ArrayList<lienzo> lienzos, ArrayList<ContentColor> listado, ArrayList<Tiempos> listTime) {
