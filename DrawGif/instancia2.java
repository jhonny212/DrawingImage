...
import java.util.ArrayList;public class instancia2{
 int x=2 ;
 int y=2 ;
String k="" ;
String f="" ;
...
if(x == 2 )
{
 ...
 pintar("VerdePalido","_id1",2,0,0,3,12,27);

}

}

public instancia2(ArrayList<lienzo> lienzos, ArrayList<ContentColor> listado, ArrayList<Tiempos> listTime) {
